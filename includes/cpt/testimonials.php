...
function testimonials() {
	...
	$labels = array(
		'name'                  => _x( 'Testimonials', 'Post Type General Name', 'mypaperhelpers' ),
		'singular_name'         => _x( 'Testimonial', 'Post Type Singular Name', 'mypaperhelpers' ),
		'menu_name'             => __( 'Testimonials', 'mypaperhelpers' ),
		'name_admin_bar'        => __( 'Testimonials', 'mypaperhelpers' ),
		...
		'add_new'               => __( 'Add New Testimonial', 'mypaperhelpers' ),
	...
	$args = array(
		'label'                 => __( 'Testimonial', 'mypaperhelpers' ),
