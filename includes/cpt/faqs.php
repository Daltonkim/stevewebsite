...
function faqs()
{
	...
	$labels = array(
		'name'                  => _x('Faqs', 'Post Type General Name', 'mypaperhelpers'),
		'singular_name'         => _x('Faq', 'Post Type Singular Name', 'mypaperhelpers'),
		'menu_name'             => __('Faqs', 'mypaperhelpers'),
		'name_admin_bar'        => __('Post Type', 'mypaperhelpers'),
		...
		'add_new'               => __('Add New Faq', 'mypaperhelpers'),
		'new_item'              => __('New Faq', 'mypaperhelpers'),
	...
	$args = array(
		'label'                 => __('Faq', 'mypaperhelpers'),
		'description'           => __('Add your FAQS', 'mypaperhelpers'),
		'labels'                => $labels,
