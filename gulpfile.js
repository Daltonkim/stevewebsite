...
// Project related.
var project = "papers"; // Project Name.
var projectURL ='papers.test'; // Project URL. Could be something like localhost:8888.

// Translation related.
var textDomain = "papers"; // Your textdomain here.
var translationFile = textDomain + ".pot"; // Name of the transalation file.
var packageName = "papers"; // Package name.
var bugReport = "https://incentro.com/contact/"; // Where can users report bugs.
var lastTranslator = "Eugene Kyale <eugene.kyale@incentro.com>"; // Last translator Email ID.
var team = "Incentro <eugene.kyale@incentro.com>"; // Team's Email ID.
...
var FrontendJSWatchFiles = [
	...
	"!assets/frontend/js/papers-editor.js",
	"!assets/frontend/js/papers-frontend.js",
...
gulp.task("FrontendScriptsJs", function() {
	...
	gulp
        ...
        gulp
		.src("assets/extensions/ext-editor-templates.js")
		.pipe(
			browserify({
				insertGlobals: true,
				debug: true
		...
		.pipe(gulp.dest("assets/qazana/js/"))
		.pipe(
			rename({
				basename: "ext-editor-templates",
				suffix: ".min"
			})
		)
		.pipe(uglify().on("error", gutil.log))
    ...
    gulp
        .src("extensions/slides/assets/js/slides/slides.js")
        .pipe(
            browserify({
                insertGlobals: true
            }).on("prebundle", function(bundler) {
        ...
        .pipe(line_ending_corrector()) //correct this specific file
        .pipe(gulp.dest("extensions/slides/assets/js"))
        .pipe(
            rename({
                basename: "slides",
                suffix: ".min"
